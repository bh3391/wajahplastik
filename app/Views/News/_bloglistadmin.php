...
<div class=" items-center justify-left  bg-gray-50">
    <div>
            ...
            <table class="  table-auto css-serial table text-xs">
                ...
                <tbody class="text-gray-600 text-sm ">
                    <?php foreach ($News as $row) : ?>
                        <tr class="border-b divide border-gray-200 hover:bg-green-100">
                            <td class="py-3 px-1 text-center"></td>
                            <td class="py-3 px-1 text-left"><span class="inline-block w-2 h-2 mr-2 bg-green-600 rounded-full"></span> <?= $row['News_writer'] ?></td>
                            ...
                            <td class="py-3 px-1 text-center"><a href="/dashboard/blogPublish/<?= $row["News_id"]; ?>"><?= $row['News_status'] ?></a></td>
