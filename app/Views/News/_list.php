...
<section class="text-gray-600 body-font overflow-hidden">
  ...
  <div class=" md:w-full px-5 md:py-10 mx-auto">
    <div class="judul text-left  mx-auto ">
      <h1 class="text-2xl text-red-600 font-bold mt-5">Berita dan Publikasi</h1>
    </div>
    <hr>

    <div class=" bg-gray-100 rounded-xl bg-opacity-60 mb-2 backdrop-filter backdrop-blur-lg">
      <?php foreach ($News as $row) : ?>

        <div data-aos="fade-left"data-aos-duration="700" class="my-1 divide-y-2 divide-gray-100 ">
          <div class="py-2 md:flex  ">
            <div class="mx-2 md:w-64 md:mb-0 mb-2  flex-shrink-0 grid md:flex-col">
            ...
            <div class="md:p-2 md:flex-wrap">
              ...
              <p class="md:leading-relaxed"><?= $row['News_description'] ?></p>
