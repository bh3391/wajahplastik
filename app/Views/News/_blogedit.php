...
<div class="container w-full p-2 space-y-6 mx-auto">
	...
	<!--  -->
	<form method="post" action="<?= base_url(); ?>/Dashboard/blogUpdate" enctype="multipart/form-data">
		<div class="row bg-gray-200 rounded-xl bg-opacity-60 backdrop-filter backdrop-blur-lg">
			<div class="md:w-5/6">
				<div class="row p-2">
					<div class="col-md-12">
						...
						<div class="form-group">
							<input value ="<?= $News->News_title ?>"required type="text" name="News_title" class="form-control w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 " required>
						</div>
					</div>
					<div class="col-md-12">
					<input value ="<?= $News->News_id ?>"required type="hidden" name="News_id" class="form-control w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 " required>
				...
				<div class="col-md-12 p-2">
					...
					<div class="form-group">
						<input value ="<?= $News->News_keyword ?>"required type="text" name="News_keyword" class="form-control
				...
				<div class="col-md-12 p-2">
					...
					<div class="form-group">
						<input  value ="<?= $News->News_tags ?>" required type="text" name="News_tags" class="form-control
						w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" required>
					</div>
				</div>
				<div class="col-md-12 p-2">
					...
					<div class="form-group">
						<input value ="<?= $News->News_source ?>" required type="text" name="News_source" class="form-control
						w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" required>
					</div>
				</div>
				<div class="col-md-12 p-2">
					...
					<div class="form-group">
						<input value ="<?= $News->News_writer ?>" required type="text" name="News_writer" class="form-control
						w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" required>
					</div>
				</div>
				<div class="col-md-12 p-2">
					...
					<div class="form-group">
						<input value ="<?= $News->News_editor ?>" required type="text" name="News_editor" class="form-control
						w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" required>
					</div>
				</div>
			</div>
			<div class="col-md-12 p-2">
				<label class="block mb-2 text-sm text-gray-600 dark:text-gray-400">Tanggal Posting<label>
						<div class="form-group">
							<input  value ="<?= $News->News_date ?>"required type="date" name="News_date" class="form-control">
						</div>
			</div>
			<div class="col-md-12 p-2">
				<label class="block mb-2 text-md text-gray-600 dark:text-gray-400">Tulis sesuatu </label>
				<textarea required name="News_content"><?= $News->News_content ?>"</textarea>
				<script>
