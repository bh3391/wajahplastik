  ...
  <div class=" px-4">
    <div class="flex flex-wrap mx-4 overflow-auto gap-4">
      <?php foreach ($tematik as $t) : ?>
        <div class="duration-1000 transition-colors hover:text-white p-2 w-full md:w-1/3 bg-gray-50 rounded-md border  delay-100 hover:bg-red-600 hover:shadow-lg">
