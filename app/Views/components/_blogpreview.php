<section class="text-gray-600 body-font" id="news">
  <div class="container md:px-5 py-10 px-5 mx-auto">
    <div  data-aos="fade-right" data-aos-duration="950" data-aos-delay="50" class="flex flex-wrap w-full mb-10">
      ...
      <p data-aos="fade-left" data-aos-duration="950" data-aos-delay="150" class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wajah Plastik Sudah Diliput dan diBeritakan oleh Media, Baik Media Online maupun Offline, Berikut Beberapa Berita dan Publikasi yang telah diperoleh Wajahplastik&trade;</p>
    </div>
    <div class="flex flex-col md:flex-row ">
      <?php foreach ($news as $row) :?>
      <div data-aos="zoom-out" data-aos-duration="950" data-aos-delay="50" class="w-full p-2 xl:w-1/3 md:p-4">
