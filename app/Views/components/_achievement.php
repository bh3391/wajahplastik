<section class="text-gray-600 body-font">
  ...
  <div class="container px-5 py-24 mx-auto">
    <h1 data-aos="fade-down" data-aos-anchor="#example-anchor" data-aos-offset="500" data-aos-duration="500" class="sm:text-3xl text-2xl font-medium title-font mb-5 text-gray-900">Achievement</h1>
    <div class="h-1 w-20 bg-red-600 rounded"></div>
    <div class="flex flex-wrap m-4">
      <?php foreach ($achievement as $a) : ?>
        <div data-aos="fade-left" data-aos-anchor="#example-anchor" data-aos-offset="500" data-aos-duration="500" class=" bg-gray-100 delay-500 duration-500 hover:bg-gray-900 hover:text-white hover:shadow-lg transition rounded-lg lg:w-1/3 lg:mb-0 mb-2 p-4">
