...
<div class="flex flex-wrap bg-gray-50 md:grid-cols-2 md:mx-auto my-5 hover:m-1 ">
    <div class="w-full md:w-1/2  p-5 flex  hover:z-10 hover:mx-1 transform hover:scale-110 hover:absolute  delay-100 duration-1000 transition-all hover:p-1 hover:bg-gray-600 ">
    ...
    <div class="w-full md:w-1/2 md:my-auto bg-gray-50 p-1 md:p-5 gap-3 ">
        ...
        <p class="p-1 md:px-10 text-gray-500 ">Tanggal Pembuatan : <?php $tanggal = date_create($gallery->gallery_sertifikatid);
        ...
        <p class="p-1 md:px-10 text-gray-500  ">Harga : Rp <?php
                                                            ...
                                                            // 1,999.89
                                                            ?></p><br>
        <a href="https://wa.link/kqshtu" class="p-1 md:my-2  md:ml-10 md:px-10 text-white shadow-sm font-bold rounded-lg bg-blue-500"><i class="fas fa-shopping-cart p-1 "></i>Pesan Sekarang</a>
