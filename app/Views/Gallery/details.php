...
<div class="flex flex-wrap md:grid-cols-2 md:mx-10 my-5 hover:m-1 ">
    <div class="w-full md:w-1/2 bg-gray-50 p-5 flex  hover:z-10 hover:mx-1 transform hover:scale-150 hover:absolute transition-transform hover:p-1 hover:bg-gray-600 ">
    ...
    <div class="w-full md:w-1/2 bg-gray-50 p-1 md:p-5 gap-3 ">
