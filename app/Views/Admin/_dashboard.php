...
<div class="p-5 text-white bg-gray-200 flex flex-row grid-row-3 place-content-around">
    <div class="p-2 mx-1 bg-green-800 rounded shadow"> Jumlah Pengunjung
    ...
    <div class="p-2 mx-1 bg-blue-900 rounded shadow">
